...
/// <summary>
/// Bulk-INSERT og spørringer mot <c>core.sample_facts</c>. CSV-importeren
/// bruker <see cref="BulkInsertAsync"/> (~50-100k rader/sek via
/// COPY-protokoll); klassifikator/analyse bruker <see cref="ListAsync"/>.
/// </summary>
public interface IScadaSampleRepository
{
    /// <summary>
